...
def main():
  ...
  parser.add_argument('--lr_decay',default=-0.15,type=float)
...
#  devSet,devlabels,devNum=DataSet.load_devSet(args.dev_data,args.dev_labels)
  ...
  optimizer = torch.optim.Adam([{'params':model.parameters()},{'params':cls_embed.parameters(),'lr':1.75*args.lr}], lr=float(args.lr))
